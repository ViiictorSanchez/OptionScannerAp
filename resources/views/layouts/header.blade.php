        ...
        <div class="container-fluid" >
            ...
            <div class="menu-extras topbar-custom">
                ...
                <ul class="float-right list-unstyled mb-0 navigation-menu ">
                    ...
                    <li class="float-right list-unstyled mb-0 has-submenu dropdown">
                        ...
                        <ul class="submenu">
                            ...
                            @endfor
                            <li><a href="#" class="dropdown-item"> <i class="mdi mdi-settings"></i>Help</a></li>
                            ...
                            <li><a href="#" class="dropdown-item text-danger"> <i class="ion-power"></i>Logout</a></li>
                        </ul>
