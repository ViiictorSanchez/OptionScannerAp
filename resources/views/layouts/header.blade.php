            ...
            <div class="menu-extras topbar-custom">
                ...
                <ul class="float-right list-unstyled mb-0 navigation-menu ">
                    ...
                    <li class="float-right list-unstyled mb-0 has-submenu ">
                        <a class="menu-color" id="list-header-menu" href="{{route('account')}}"><strong>{{$account[0]}}</strong><i class="fas fa-sort-down"></i></a>
                        <ul class="submenu">
                            @php $count = sizeof($account) @endphp
                            @for ($i = 0; $i < $count; $i++)
                                <li><a class="menu-color" id="list-header-menu" href={{route('account')}}><strong>{{$account[$i]}}</strong></a></li>
                            @endfor
