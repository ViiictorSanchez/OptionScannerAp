...
!function ($) {
    ...
    var MorrisCharts = function () {
        ...
        MorrisCharts.prototype.init = function () {
            ...
            this.createAreaChart('morris-area-example', 0, 0, $areaData, ['a'/*, 'b', 'c'*/], [/*'Series A', 'Series B',*/ 'Series A'], ['#ccc'/*, '#7a6fbe', '#28bbe3'*/]);

            //creating area chart
           // this.createAreaChart('morris-area-example3', 0, 0, $areaData, ['a'/*, 'b', 'c'*/], [/*'Series A', 'Series B',*/ 'Series A'], ['#ccc'/*, '#7a6fbe', '#28bbe3'*/]);
           // this.createAreaChart('morris-area-example4', 0, 0, $areaData, ['a'/*, 'b', 'c'*/], [/*'Series A', 'Series B',*/ 'Series A'], ['#ccc'/*, '#7a6fbe', '#28bbe3'*/]);
